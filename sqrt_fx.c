...
Word16 Sqrt16( Word16  mantissa, /*!< i/o mantissa */  Word16 *exponent  /*!< pointer to exponent */);
...
void main(){
	//example 1 
	Word16 m = (1<<4); // 16/32768 = 0.00048828125
	Word16 e = 2;      // 0.00048828125*2^2 = 0.001953125    // sqrt(0.001953125) = 0.04419417382
	Word16 sqrt_m = Sqrt16(m, &e);
	printf("sqrt_m=%d\n",sqrt_m); // sqrt_m=23171  23171/32768 = 0.7071228
	printf("e=%d\n",e); // e=-4    23171/32768*2^-4 = 0.04419517517
